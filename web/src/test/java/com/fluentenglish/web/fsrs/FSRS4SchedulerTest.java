...
class FSRS4SchedulerTest {
    ...
    void test_learnMaterialFirstTime() {
        ...
        assertIntervalApproximatelyEquals(againMemo.getLastStudied(), againMemo.getNextStudy(), 0.4f);
        ...
        assertIntervalApproximatelyEquals(hardMemo.getLastStudied(), hardMemo.getNextStudy(), 0.6f);
        ...
        assertIntervalApproximatelyEquals(goodMemo.getLastStudied(), goodMemo.getNextStudy(), 2.4f);
        ...
        assertIntervalApproximatelyEquals(easyMemo.getLastStudied(), easyMemo.getNextStudy(), 5.8f);
    }
    ...
    void test_reviewMaterial(){
        ...
        memo.setLastStudied(new Date(0));
        ...
        assertIntervalApproximatelyEquals(againMemo.getLastStudied(), againMemo.getNextStudy(), 0.2723f);
        ...
        assertIntervalApproximatelyEquals(hardMemo.getLastStudied(), hardMemo.getNextStudy(), 0.6417f);
        ...
        assertIntervalApproximatelyEquals(goodMemo.getLastStudied(), goodMemo.getNextStudy(), 1.2333f);
        ...
        assertIntervalApproximatelyEquals(easyMemo.getLastStudied(), easyMemo.getNextStudy(), 2.5748f);
    }
