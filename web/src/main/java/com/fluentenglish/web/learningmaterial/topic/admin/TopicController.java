...
import com.fluentenglish.web.common.exception.userinput.UserInputErrors;
import com.fluentenglish.web.common.exception.userinput.UserInputErrorsImpl;
...
public class TopicController {
    ...
    public RedirectView createTopic(@Valid TopicCreateUpdateDto topicDto,
        ...
        UserInputErrors userInputErrors = getUserInputErrors(errors);
        if (userInputErrors != null) {
            redirectAttributes.addFlashAttribute("userInputErrors", userInputErrors);
    ...
    @GetMapping("/{id}")
    public ModelAndView getTopicDetailPage(@PathVariable int id) {
    ...
    private UserInputErrors getUserInputErrors(Errors errors) {
        ...
        return new UserInputErrorsImpl(errorInfos);
    }
}
