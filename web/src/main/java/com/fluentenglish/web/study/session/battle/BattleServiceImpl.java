...
import com.fluentenglish.web.gaming.user.PlayerProcessService;
...
public class BattleServiceImpl implements BattleService{
    ...
    private final PlayerProcessService playerProcessService;
    ...
    public BattleServiceImpl(RedisUserStudySessionDao userStudySessionDao,
        ...
        this.playerProcessService = playerProcessService;
    ...
    private BattleInfo initializeRedisBattle(String sessionId) {
        ...
        int chapterNumber = playerProcessService.getStoryProcess(studySession.getUserId()).getChapterNumber();
    ...
    private BattleResult endRedisBattle(String sessionId) {
        ...
        BeforeAfterStoryProcessDto chapterProcessDto = playerProcessService.addChapterProgress(studySession.getUserId(), getRandomChapterProcess(0.03f, 0.08f));
        LevelBeforeAfterDto levelProcessDto = userInfoService.addExperience(studySession.getUserId(), battleInfo.getExpGain());
        ...
        return new BattleResult(chapterProcessDto, levelProcessDto, currentStateDto);
    }
    ...
    public Float getRandomChapterProcess(Float minPercent, Float maxPercent) {
